...
class ForecastPage extends StatefulWidget {
  ...
  @override
  State<ForecastPage> createState() => _ForecastPageState(); // Fix: Use correct class name
}
...
class WeatherCard extends StatelessWidget {
  ...
  WeatherCard({required this.date, required this.temp, required this.condition,required this.isFirst});
    @override
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: isFirst ? Colors.green.shade100 : const Color.fromARGB(255, 221, 241, 201),
